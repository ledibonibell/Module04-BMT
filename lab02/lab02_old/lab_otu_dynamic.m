...
<<<<<<< Updated upstream
sgtitle('Колебательные звенья с разным коэффициентом демпфирования (консервативное звено)')
saveas(gcf, 'graphics/Консервативное звено.png');
=======
sgtitle('Консервативное звено')
saveas(gcf, 'graphics/Колебательные звенья с разным коэффициентом демпфирования.png');
>>>>>>> Stashed changes
